...
/**
 * @author bing  @create 2020/5/19 9:21 下午
 */
// 配置 -> 数据库 -> 调用
@Configuration
...
//    @Bean
    public JobDetailFactoryBean alphaJobDetail() {
        ...
        factoryBean.setJobClass(AlphaJob.class);//JOB 的类型
        factoryBean.setName("alphaJob");// 任务的名字，不能重复
...
//    @Bean
    public SimpleTriggerFactoryBean alphaTrigger(JobDetail alphaJobDetail) {
        ...
        factoryBean.setRepeatInterval(3000);// 3秒执行一次
    ...
    public SimpleTriggerFactoryBean postScoreRefreshTrigger(JobDetail postScoreRefreshJobDetail){
        ...
        factoryBean.setRepeatInterval(1000 * 60 * 120);//设置重复的频率5分钟
